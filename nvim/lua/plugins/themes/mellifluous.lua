  ...
  config = function()
    require('mellifluous').setup({
      ...
      transparent_background = {
        enabled = true,
        floating_windows = false, -- keep floats opaque to avoid tint
        telescope = true,
        file_tree = true,
        cursor_line = false,
        status_line = false,
    ...
    vim.schedule(function()
      ...
      local c = {
          ...
          -- Foregrounds
          fg = "#dadada",         -- Normal text
          fg_dark = "#CCCCCC",    -- Dimmed text (Telescope Normal, comments sometimes)
          fg_dim = "#5b5b5b",     -- Very dim (LineNr, out of focus)
          fg_gutter = "#4d4d4d",  -- Gutter/Conceal
          -- Accents / Syntax
          red = "#d59192",        -- Errors, keywords
          orange = "#cbaa88",     -- Main keywords, accent, alpha header
          yellow = "#bfaf8e",     -- Strings, warnings
          green = "#b3b393",      -- Additions, strings sometimes
          cyan = "#a8a1be",       -- Types, info
          blue = "#a8a1be",       -- Functions
          magenta = "#b99bb5",    -- Constants, hints
          -- Borders
          border = "#282828",
          -- Specific overrides
          comment = "#7a6456",
      ...
      hl(0, "CursorLineNr", { bg = c.bg_bright, fg = c.white, bold = true, italic = true })
      hl(0, "CursorLine", { bg = c.bg_bright })
      ...
      -- ── Neo-tree ─────────────────────────────────────────
      hl(0, 'NeoTreeNormal', { bg = c.ui_bg, fg = c.fg })
      hl(0, 'NeoTreeNormalNC', { bg = c.ui_bg, fg = c.fg })
      ...
      hl(0, 'NeoTreeGitUntracked', { fg = c.magenta })

      hl(0, 'NeoTreeDimText',     { fg = c.fg_gutter })           
      hl(0, 'NeoTreeDotfile',     { fg = c.fg_gutter, italic = true }) 
      hl(0, 'NeoTreeHiddenByName',{ fg = c.fg_gutter, italic = true }) 
      hl(0, 'NeoTreeGitIgnored',  { fg = c.fg_gutter, italic = true }) 
      hl(0, 'NeoTreeIgnored',     { fg = c.fg_gutter, italic = true }) 
      ...
      hl(0, "TelescopeResultsClass", { fg = c.cyan })
      hl(0, "TelescopeResultsComment", { fg = c.comment, italic = true })
      hl(0, "TelescopeResultsConstant", { fg = c.magenta })
      hl(0, "TelescopeResultsField", { fg = c.blue })
      hl(0, "TelescopeResultsFunction", { fg = c.blue })
      hl(0, "TelescopeResultsIdentifier", { fg = c.fg })
      hl(0, "TelescopeResultsLineNr", { bg = c.ui_bg, fg = c.fg_dim })
      hl(0, "TelescopeResultsNumber", { fg = c.magenta })
      ...
      hl(0, "TelescopePreviewMatch", { bg = c.bg_search, fg = c.orange })
      hl(0, "TelescopePreviewLine", { bg = c.bg_visual })

      hl(0, "TelescopeSelection", { bg = c.bg_search })
      ...
      hl(0, "WhichKeyDesc", { fg = c.magenta })         -- The description of the key
